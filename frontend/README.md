...
| `OPENAI_MAX_COMPLETION_TOKENS` | No (defaults to `1500`) | `1500` is fine for the `gpt-4.1-mini` default. Bump to `4000` if you override `OPENAI_MODEL=gpt-5` so reasoning has room. |
